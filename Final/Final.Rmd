...
# List of packages
packages <- c("wikiTools", "httr", "jsonlite", "data.table", "readr", "tidyr", 
              "pbapply", "dplyr", "ggplot2", "patchwork", "stringr", "pracma", "reshape2") # nolint
...
(b) (12 pt) Here we’ll investigate the [birthday paradox](https://en.wikipedia.org/wiki/Birthday_problem), which suggests that in a random group, the probability of finding at least two people with the same birthday is higher than we might intuitively expect. 
